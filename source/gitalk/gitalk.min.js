! function(e, t) {
    ...
    return function(e) {
        ...
        function r(e, t) {
            ...
            if (v) {
                ...
                return c.time && (b = u(c.time)), g = 0, new Date(y + b)
            }
            return new Date(e)
        }
        ...
        e.exports = function(e, t, n, m, v, g, y) {
            ...
            if (M && (w = f(M.call(new e))) !== Object.prototype && (l(w, E, !0), r || u(w, p) || a(w, p, h)), N && O && "values" !== O.name && (C = !0, T = function() {
                    return O.call(this)
                }), r && !y || !d && !C && S[p] || a(S, p, T), s[t] = T, s[E] = h, v)
                if (b = {
                        values: N ? T : x("values"),
                        keys: g ? T : x("keys"),
                        entries: A
        ...
        ! function() {
            ...
            function E(e, t, n) {
                var r, o = B[e.name];
                if (e.prototype && e.prototype.render ? (r = new e(t, n), A.call(r, t, n)) : (r = new A(t, n), r.constructor = e, r.render = N), o)
            ...
            function S(e, t, n, o) {
                if (!e.__x) {
                    ...
                    if (!g || n ? L.unshift(e) : x || (m(), e.componentDidUpdate && e.componentDidUpdate(p, d, h), k.afterUpdate && k.afterUpdate(e)), null != e.__h)
                ...
                return (0, g.default)(t, e), (0, d.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return b.default.createElement("div", {
                            ...
                            text: this.i18n.t("login-with-github-btn")
                        }))
                    }
                }, {
                    key: "header",
    ...
    }, function(e, t) {  // Changing this item is enough!
        e.exports = {
            init: "Gitalking...",
            "no-found-related": "Related %{link} not found",
            "please-contact": "Please contact %{user} to initialize the comment",
            "init-issue": "INIT ISSUE",
            "leave-a-comment": "Leave a comment here.",
            comment: "COMMENT",
            "support-markdown": "Markdown is supported",
            "login-with-github-btn": "LOG IN",
            "login-with-github": "Log in",
            "first-comment-person": "Your're the first person to leave a comment.",
            commented: "commented",
            "load-more": "MORE",
